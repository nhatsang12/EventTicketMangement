    ...
    <Reveal variant="fadeUp" delay={index * 60} threshold={0.06}><Link to={`/event/${event._id}`} className="hp2-card" style={{
      ...
      <div style={{ padding: "16px 18px 18px" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", borderTop: "1px solid rgba(255,255,255,0.07)", paddingTop: 14 }}>
          ...
          <span style={{ fontSize: 12, fontWeight: 800, color: "white", padding: "9px 20px", borderRadius: 999, background: urgency?.level === "critical" ? "linear-gradient(135deg,#ef4444,#f97316)" : "linear-gradient(135deg,#f97316,#a855f7)", fontFamily: "'Be Vietnam Pro',sans-serif", boxShadow: "0 4px 18px rgba(249,115,22,0.3)", display: "flex", alignItems: "center", gap: 5, transition: "all 0.2s", whiteSpace: "nowrap", flexShrink: 0 }} className="hp2-cta-btn">
    ...
    <Reveal variant="fadeLeft" delay={0} duration={800} style={{ height: "100%" }}><Link to={`/event/${event._id}`} className="hp2-tall-card" style={{
      ...
      <div style={{ position: "absolute", bottom: 0, left: 0, right: 0, padding: "20px 20px" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", borderTop: "1px solid rgba(255,255,255,0.1)", paddingTop: 14 }}>
          ...
          <span style={{ fontSize: 12, fontWeight: 800, color: "white", padding: "10px 20px", borderRadius: 999, background: "linear-gradient(135deg,#f97316,#a855f7)", fontFamily: "'Be Vietnam Pro',sans-serif", boxShadow: "0 6px 24px rgba(249,115,22,0.3)", display: "flex", alignItems: "center", gap: 5, whiteSpace: "nowrap", flexShrink: 0 }}>
...
const EventListRow = ({ event, index = 0 }) => {
  ...
  return (
    <Reveal variant="fadeRight" delay={index * 50} duration={600}><Link to={`/event/${event._id}`} className="hp2-list-row" style={{
      ...
      <div className="hp2-list-thumb" style={{ width: 140, height: 110, flexShrink: 0, overflow: "hidden", background: "#1c1c1e", position: "relative" }}>
      ...
      <div className="hp2-list-body" style={{ flex: 1, padding: "14px 16px", minWidth: 0, display: "flex", flexDirection: "column", justifyContent: "center" }}>
  ...
  return (
    <section ref={sectionRef} style={{ background: "linear-gradient(180deg,#0a0f0e 0%,#080c0b 100%)", borderTop: "1px solid rgba(255,255,255,0.05)" }}>
      <div style={{ maxWidth: 1152, margin: "0 auto", padding: "52px 24px 28px" }}>
        <div className="hp2-all-header" style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 16, flexWrap: "wrap", marginBottom: 24 }}>
          <div>
      ...
      <div style={{ maxWidth: 1152, margin: "0 auto", padding: "0 24px 60px" }}>
        ...
        {!loading && displayed.length > 0 && viewMode === "grid" && (
          <div className="hp2-events-grid" style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gridAutoRows: "auto", gap: 18 }}>
            <div className="hp2-tall-wrapper" style={{ gridColumn: "span 2", gridRow: "span 2" }}>
...
const LocationsSection = () => (
  <section style={{ background: "linear-gradient(135deg,#080f0d 0%,#090e0c 60%,#070c0a 100%)", padding: "80px 0", borderTop: "1px solid rgba(16,185,129,0.08)" }}>
    <div style={{ maxWidth: 1152, margin: "0 auto", padding: "0 24px" }}>
      ...
      <div className="hp2-loc-grid" style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 12 }}>
        {LOCATIONS.map((loc, i) => (
          <Reveal key={loc.name} variant={i === 0 ? "fadeLeft" : i % 2 === 0 ? "fadeRight" : "fadeUp"} delay={i * 70} duration={700} threshold={0.06}><Link to={`/?location=${encodeURIComponent(loc.name)}`} className={`hp2-loc-card ${i === 0 ? 'hp2-loc-featured' : ''}`} style={{ position: "relative", overflow: "hidden", borderRadius: 16, textDecoration: "none", gridColumn: i === 0 ? "span 2" : "span 1", gridRow: i === 0 ? "span 2" : "span 1", display: "block" }}>
...
const HomePage = () => {
  ...
  return (
    <div className="hp2-root" style={{ marginTop: -64 }}>

      {/* ── HERO ── */}
      <section className="hp2-hero" style={{ position: "relative", background: "#060606", overflow: "hidden", minHeight: "100svh", display: "grid", gridTemplateColumns: "1fr 1fr", alignItems: "stretch" }}>
        <div className="hp2-hero-content" style={{ position: "relative", zIndex: 10, display: "flex", flexDirection: "column", justifyContent: "center", padding: "80px 48px 80px 60px" }}>
      ...
      {/* ── FILTER BAR ── */}
      <nav style={{ position: "sticky", top: 64, zIndex: 40 }}>
      ...
      <style>{`
        ...
        @media (max-width:1024px) {
          .hp2-hero-content { padding:60px 32px 60px 36px !important; }
          .hp2-events-grid { grid-template-columns:repeat(2,1fr) !important; }
          .hp2-tall-wrapper { grid-column:span 2 !important; grid-row:span 1 !important; }
          .hp2-all-controls { flex-wrap:wrap; }
        }

        /* ── MOBILE: ≤768px ── */
        @media (max-width:768px) {
          /* Hero */
          .hp2-hero { grid-template-columns:1fr !important; min-height:auto !important; }
          .hp2-hero > div:last-child { display:none !important; }
          .hp2-hero-content { padding:100px 20px 48px !important; }

          /* All Events grid */
          .hp2-events-grid { grid-template-columns:1fr !important; gap:14px !important; }
          .hp2-tall-wrapper { grid-column:span 1 !important; grid-row:span 1 !important; }
          ...
          .hp2-list-thumb { width:100% !important; height:160px !important; }
          .hp2-list-body { padding:14px 16px !important; }
          .hp2-list-price {
          ...
          /* Location grid */
          .hp2-loc-grid { grid-template-columns:1fr !important; }
          .hp2-loc-featured { grid-column:span 1 !important; grid-row:span 1 !important; }
          .hp2-loc-card img { height:180px !important; }

          /* Filter bar - compact horizontal scroll on mobile */
          .hp2-filter-date-row {
          ...
          .hp2-spacer { display:none !important; }
          .hp2-filter-price {
          ...
          /* Hero compact */
          .hp2-hero-content h1 { font-size:clamp(2rem,6vw,2.8rem) !important; }
          .hp2-hero-content form { flex-direction:row !important; }
          .hp2-hero-content form button[type="submit"] { padding:10px 14px !important; font-size:11px !important; }
        }

        /* ── SMALL MOBILE: ≤480px ── */
        @media (max-width:480px) {
          .hp2-hero-content { padding:80px 16px 36px !important; }
          .hp2-hero-content h1 { font-size:1.8rem !important; line-height:1.1 !important; }
          .hp2-hero-content p { font-size:12px !important; margin-bottom:24px !important; }
          .hp2-hero-content form { margin-bottom:20px !important; }
